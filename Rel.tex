...
\subsection{$\forall R$ and Comparison with adjoints}
Recall the contravariant inverse image functor $(-)_\ast : \Rel^\op
\to \Rel$ taking an $R : X \to Y$ to $R_\ast : 2^Y \to 2^X$ defined by 
\[
Y' \sim_{R_\ast} X' \quad \equiv \quad 
\]
